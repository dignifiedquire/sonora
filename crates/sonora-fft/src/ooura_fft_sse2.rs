    ...
    unsafe {
        ...
        // Second block (k=64)
        {
            ...
            for j0 in (k..l + k).step_by(2) {
                let a_00 = _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0) as *const __m128i));
                let a_08 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 8) as *const __m128i));
                let a_32 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 32) as *const __m128i));
                let a_40 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 40) as *const __m128i));
                ...
                let a_16 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 16) as *const __m128i));
                let a_24 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 24) as *const __m128i));
                let a_48 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 48) as *const __m128i));
                let a_56 =
                    _mm_castsi128_ps(_mm_loadl_epi64(a.as_ptr().add(j0 + 56) as *const __m128i));
